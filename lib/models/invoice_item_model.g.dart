...
InvoiceItem _invoiceItemDeserialize(
  ...
  final object = InvoiceItem(
    ...
    quantity: reader.readLongOrNull(offsets[2]) ?? 1,
  );
  return object;
}
...
extension InvoiceItemQueryFilter
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> nameEqualTo(
    String value, {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> nameGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> nameLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> nameBetween(
    String lower,
    String upper, {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> nameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> nameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> nameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> nameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'name',
        value: '',
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> priceEqualTo(
    double value, {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> priceLessThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<InvoiceItem, InvoiceItem, QAfterFilterCondition> priceBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
